...
func scanNullableUser(fields nullableUserFields) models.User {
	if !fields.ID.Valid {
		return models.User{}
	}
...
func scanNullableLastMessage(fields nullableLastMessageFields) models.LastMessage {
...
func (r *Repository) scanChatWithDetails(rows pgx.Rows) (models.ChatWithDetails, error) {
	var (
		chat      models.ChatWithDetails
